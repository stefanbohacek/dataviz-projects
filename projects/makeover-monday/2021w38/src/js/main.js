...
import median from "/js/modules/median.min.js";
...
const allData = {
  ...
  Malware: [
    ...
    {
      product:
        "USA, CA, UK, AU low quality, slow speed, low success rate x 1,000",
  ...
  "DDOS Attacks": [
    {
      ...
      product_short: [
        "Unprotected website",
        "10-50k requests per second, 1 hour",
      ],
      avg_dark_web_price_usd: 15,
    },
    {
      ...
      product_short: [
        "Unprotected website",
        "10-50k requests per second, 24 hours",
      ],
      avg_dark_web_price_usd: 50,
    },
    {
      ...
      product_short: [
        "Unprotected website",
        "10-50k requests per second, 1 week",
      ],
      avg_dark_web_price_usd: 500,
    },
    {
      ...
      product_short: [
        "Unprotected website",
        "10-50k requests per second, 1 month",
      ],
      avg_dark_web_price_usd: 1000,
    },
    {
      ...
      product_short: [
        "Europe low quality",
        "slow speed",
        "low success rate x 1,000",
      ],
      avg_dark_web_price_usd: 320,
    },
    {
      product:
        "Premium protected website, 20-50k requests per second, multiple elite proxies, 24 hours",
      // "product_short": "Premium protected website, 20-50k requests per second, multiple elite proxies, 24 hours",
      product_short: [
        "Premium protected website",
        "20-50k requests per second",
...
const showDataset = (chart, dataset, title, subtitle) => {
  ...
  dataset = sortArrayOfObjects(dataset, "avg_dark_web_price_usd");
  ...
  chart.options.plugins.subtitle.text = `Median price: \$${median(dataValues)}`;
  chart.update();

  description.innerHTML = "";
  highlightMax(chart, "#7f5af0");
};
