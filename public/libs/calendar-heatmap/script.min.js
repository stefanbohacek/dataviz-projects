...
function calendarHeatmap() {
  ...
  function chart() {
    ...
    var dateRange = ((d3.time && d3.time.days) || d3.timeDays)(yearAgo, now);
    var monthRange = ((d3.time && d3.time.months) || d3.timeMonths)(moment(yearAgo).startOf('month').toDate(), now); 
